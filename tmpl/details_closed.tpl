  <table cellspacing=0 cellpadding=1 border=0 width=100%><tr><td class=closeddark>
   <table cellspacing=0 cellpadding=2 border=0 class=closedlite width=100%>
    <tr>
